...
?>
    ...
    <h2 class="text-center"> Thank you for visiting Bessem Car Rental! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            ?></h4>
                ...
                ?>
                <h4> <strong>Total Fine:</strong> <label class="text-danger"> D<?php echo $total_fine; ?>/- </label> for <?php echo $extra_days;?> extra days.</h4>
                <br>
                <?php } ?>
                <h4> <strong>Total Amount: </strong> D<?php echo $total_amount; ?>/-     </h4>
                <br>
            </div>
        </div>
