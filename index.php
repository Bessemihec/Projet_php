                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: white">Bessem CAR RENTAL</h1>
                            <p class="intro-text">
...
<br>
        <section class="menu-content">
            ...
            <h6> AC Fare: <?php echo ("D" . $ac_price . "/km & D" . $ac_price_per_day . "/day"); ?></h6>
            <h6> Non-AC Fare: <?php echo ("D" . $non_ac_price . "/km & D" . $non_ac_price_per_day . "/day"); ?></h6>
        ...
        <div class="w3-row w3-padding-32 w3-section">
            ...
            <div class="w3-col m8 w3-panel">
                <div class="w3-large w3-margin-bottom">
                    <i class="fa fa-map-marker fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Bessem, Tunisia<br>
                ...
                <p>New to Bessem ? Drop Your Details and Leave it on us We'll Revert</p>
