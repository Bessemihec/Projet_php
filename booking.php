...
<div class="container" style="margin-top: 65px;" >
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <div ng-switch-default>
                ...
                <!-- </div>    -->
                    ...
                    <!-- <div class="form-group"> -->
                <h5>Fare: <?php echo("D" . $ac_price . "/km and D" . $ac_price_per_day . "/day");?><h5>    
                <!-- </div>    -->
                     </div>
                     <div ng-switch-when="non_ac">
                     <!-- <div class="form-group"> -->
                <h5>Fare: <?php echo("D" . $non_ac_price . "/km and D" . $non_ac_price_per_day . "/day");?><h5>    
                <!-- </div>   -->
                     </div>
        </div>
      ...
      <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6><strong>Kindly Note:</strong> You will be charged <span class="text-danger">D 200/-</span> for each day after the due date.</h6>
        </div>
    </div>
